		...
		<div id="main">
			...
			<article id="find">
				...
				<form method="post" action="" id="fi" name="fi">
					<div class="fields">
						<div class="field half">
							<label for="find_id_nickname">NICKNAME</label>
							<input type="text" name="find_id_nickname" id="find_id_nickname" />
						</div>
						<div class="field half">
							<label for="find_id_email">EMAIL</label>
							<input type="email" name="find_id_email" id="find_id_email" />
						</div>
					</div>
					<ul class="actions">
	...
	* 수탁업체
		...
		- 행정자치부
		  ...
		  · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음</textarea>
					...
					<span id="span"></span>
					<button type="button" id="checkSubmit" onclick="location.href='#joinPro'">제출하기</button>
				</form>
			</article>
			...
			<article id="joinPro">
				...
				<form method="post" action="Join" id="fr" name="fr" onsubmit="return checkForm()">
					<div class="fields">
						<div class="field half">
							<label for="join_nickname">Nickname</label> 
							<input type="text" name="join_nickname" id="join_nickname" />
						...
						<div class="field half">
							<label for="join_passwd">Password</label>
							<input type="password" name="join_passwd" id="join_passwd" onkeyup="checkPass(this.value)"/>
							<span id="passSafe"></span>
						</div>
						<div class="field half">
							<label for="passwd_check">Password Check</label> 
							<input type="password"name="passwd_check" id="passwd_check" onkeyup="checkPassResult(this.value)"/> 
								<span id="passCheck"></span>
						</div>
						<div class="field half">
							<label for="join_email1">Email</label> 
							<input type="text" name="join_email1" id="join_email1" onkeyup="checkEmail(this.value)" />
						...
						<div class="field half">
							...
							<select id="join_gender" name="gender">
								<option value="male">남자</option>
								<option value="female">여자</option>
							</select>
						</div>
						<div class="field half">
							<label for="join_age">나이</label> 
							<select id="join_age" name="age">
						...
						<div class="field half">
							<label for="join_style">Style</label> 
						...
						<div class="field half">
							<label for="join_brand">Brand</label> 
						...
						<div class="field half">
							<label for="join_category">Like Item</label> 
